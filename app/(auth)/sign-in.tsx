...
import {PrimaryButton, PrimaryButtonOutline } from "../../components/buttons/Button";
...
export default function SignIn() {
    ...
    return (
        <View style={globalStyles.containerFlexCenter}>
            ...
            <PrimaryButtonOutline text={"Sign up"} callBack={() => signIn()} pressableStyle={{marginBottom: 24}} size={"large"} />
        </View>
    )
}